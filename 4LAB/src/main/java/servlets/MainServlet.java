    ...
    public class MainServlet extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
            ...
            out.print("<th><a href='?sort=amount&order=" + (sort.equals("amount") && order.equals("asc") ? "desc" : "asc") + "'>Количество</a></th>");
            out.print("</tr>");
...
//                    items.sort((o1, o2) -> finalOrder.equals("asc") ? Integer.compare((Integer)o1.get("id"), (Integer)o2.get("id")) : Integer.compare((Integer)o2.get("id"), (Integer)o1.get("id")));
                ...
                for (Map<String, Object> item : items) {
                    ...
                    out.print("<td>" + item.get("amount") + "</td>");
                    out.print("<td>");
                    out.print("<a href='delete?id=" + item.get("id") + "' style='color: red;'>Удалить</a> | ");
                    out.print("<a href='edit?id=" + item.get("id") + "&name=" + URLEncoder.encode(item.get("name").toString(), "UTF-8") + "&price=" + item.get("price") + "&amount=" + URLEncoder.encode(item.get("amount").toString(), "UTF-8") + "' style='color: green;'>Редактировать</a>");
                    out.print("</td>");
                    out.print("</tr>");
                }
            ...
            out.print("<form method='post' action='/4LAB_war/test'>");
            ...
            out.print("<label for='amount'>Количество:</label>");
            out.print("<input type='text' id='amount' name='amount'><br>");
        ...
        protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
            ...
            mainService.addName(name, price, amount);
            System.out.println(name + ", " + price + ", " + amount);
            resp.sendRedirect("/4LAB_war/test");
        }
    }