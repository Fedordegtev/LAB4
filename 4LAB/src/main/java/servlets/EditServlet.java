...
public class EditServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            String encodedamount = req.getParameter("amount");
            String decodedamount = new String(encodedamount.getBytes("ISO-8859-1"), "UTF-8");
            String amount = decodedamount;

            mainService.editName(id, name, price, amount);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        out.print("<form method='post' action='/4LAB_war/edit'>");
        ...
        out.print("<input type='text' id='amount' name='amount' value='" + req.getParameter("amount") + "'>");
